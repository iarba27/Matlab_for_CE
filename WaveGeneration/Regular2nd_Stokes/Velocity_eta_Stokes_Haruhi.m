...
save('CASE_CYL_time.txt','time','-ASCII');
save('CASE_CYL_vel_1st_x.txt','u','-ASCII');
save('CASE_CYL_vel_1st_z.txt','v','-ASCII');
save('CASE_CYL_eta_1st.txt','eta','-ASCII');
save('CASE_CYL_vel_2nd_x.txt','u_2','-ASCII');
save('CASE_CYL_vel_2nd_z.txt','v_2','-ASCII');
save('CASE_CYL_eta_2nd.txt','eta_2','-ASCII');
